...
for ( let i = 0; i < coursesAndDurationArray.length; i++){
 let arr = coursesAndDurationArray[i];
    let title = arr.title
    let courses = arr.monthDuration
    let div = document.createElement(`div`)
div.innerText = `${title} ${courses}`
    document.body.appendChild(div)
}
...
for (let i = 0; i < coursesAndDurationArray2.length; i++) {
    let arr = coursesAndDurationArray2[i];
    let title = arr.title
    let courses = arr.monthDuration
    let div = document.createElement(`div`)
...
for (const simpson of simpsons) {
    ...
    simpsonBlock.innerText = `${simpson.name} ${simpson.surname} ${simpson.age} ${simpson.info}`
    let img = document.createElement(`img`)
    img.src = simpson.photo
    document.body.append(simpsonBlock, img)
}
// =========================
//     Цикл в циклі
...
for (const coursesArrayElement of coursesArray2) {
    let arrBlock = document.createElement(`div`)
    let h1 = document.createElement(`h1`)
